...
app.promise = function(Prom, defer, optAsyncResolve) {
  var def = defer();
  var def2 = defer();
  var def3 = defer();
  var def4 = defer();
  ...
  setImmediate(def2.resolve);
  setImmediate(def3.resolve);
  setImmediate(def4.resolve);
  setImmediate(def5.resolve);
  setImmediate(def6.resolve);
...
app.vanilla = function(perf, optAsyncResolve, cb) {
  ...
  var fndo6 = function do6() { setImmediate(do7); };
  var fndo5 = function do5() { setImmediate(fndo6); };
  var fndo4 = function do4() { setImmediate(fndo5); };
  var fndo3 = function do3() { setImmediate(fndo4); };
  var fndo2 = function do2() { setImmediate(fndo3); };
  function do1() { setImmediate(fndo2); }
